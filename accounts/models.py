...
class MyAccountManager(BaseUserManager):
    ...
    # 관리자 User 생성
    def create_superuser(self, username, email, profile, password, **extra_fields):
...
class User(AbstractBaseUser):
    ...
    profile = models.FileField(upload_to='profile/%Y/%m/%d', default="profile/default.png")
    ...
    REQUIRED_FIELDS = ['email', 'profile']  # 필수 작성 필드
